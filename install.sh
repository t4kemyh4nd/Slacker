...
echo "{\"FB_APP_ID\": \"$FB_APP_ID\", \"FB_ACCESS_TOKEN\": \"$FB_ACCESS_TOKEN\", \"SLACK_BOT_TOKEN\": \"$SLACK_BOT_TOKEN\", \"SLACK_WEBHOOK_URL\": \"$SLACK_WEBHOOK_URL\", \"DIRSEARCH_PATH\": \"$DIRSEARCH_PATH\"}" > ./config.json
