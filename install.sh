...
echo "export FB_APP_ID=$FB_APP_ID" >> /etc/enviroment

echo "export FB_ACCESS_TOKEN=$FB_ACCESS_TOKEN" >> ~/.bashrc
echo "export FB_ACCESS_TOKEN=$FB_ACCESS_TOKEN" >> ~/.profile
echo "export FB_ACCESS_TOKEN=$FB_ACCESS_TOKEN" >> /etc/environment
...
echo "export SLACK_BOT_TOKEN=$SLACK_BOT_TOKEN" >> /etc/environment
